...
export declare function welcomeMessage(ctx: ContactContext, options?: {
    intro?: string | null;
}): string;
/**
 ...
 */
export declare function detectProfileIntent(input: string): "dueno" | "taller" | "almacen" | "cuenta" | null;
